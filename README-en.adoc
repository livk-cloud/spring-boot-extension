image:https://github.com/livk-cloud/spring-boot-example/actions/workflows/jdk21-ci.yml/badge.svg?branch=main["Build Status",
link="https://github.com/livk-cloud/spring-boot-example/actions/workflows/jdk21-ci.yml"]
image:https://github.com/livk-cloud/spring-boot-example/actions/workflows/jdk22-ci.yml/badge.svg?branch=main["Build Status",
link="https://github.com/livk-cloud/spring-boot-example/actions/workflows/jdk22-ci.yml"]
...
|--spring-boot-example
    ...
    |--spring-extension-testcontainers(testcontainers test kits)
----
