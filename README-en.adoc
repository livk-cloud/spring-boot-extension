...
image:https://img.shields.io/badge/Spring%20Framework-6.1.6-green[link="https://spring.io/projects/spring-framework"]
image:https://img.shields.io/badge/Spring%20Boot-3.2.5-green[link="https://spring.io/projects/spring-boot"]
