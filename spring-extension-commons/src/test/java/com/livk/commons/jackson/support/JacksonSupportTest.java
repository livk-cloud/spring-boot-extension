...
class JacksonSupportTest {
    ...
    static final JacksonSupport<JsonMapper> JSON = JacksonSupport.create(JacksonType.JSON);

    static final JacksonSupport<YAMLMapper> YAML = JacksonSupport.create(JacksonType.YAML);

    static final JacksonSupport<XmlMapper> XML = JacksonSupport.create(JacksonType.XML);
