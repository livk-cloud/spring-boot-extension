...
public class PulsarAutoConfiguration {
    ...
    public PulsarClient pulsarClient(PulsarProperties properties) throws PulsarClientException {
        return PulsarClient.builder()
                .serviceUrl(properties.getAddress())
                .build();
    }

    @ConditionalOnMissingBean
    @Bean(destroyMethod = "close")
    public Producer<String> producer(PulsarClient client,
                                     PulsarProperties properties) throws PulsarClientException {
