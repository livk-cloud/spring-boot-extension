 ...
 * {@link Rest5ClientBuilder} to fine-tune its autoconfiguration before it creates a
 * {@link Rest5Client}.
 *
 * @author Brian Clozel
 * @author Vedran Pavic
...
public interface Rest5ClientBuilderCustomizer {
	...
	/**
	 * Customize the {@link RequestConfig.Builder}. Unlike
	 * {@link Rest5ClientBuilder#setRequestConfigCallback(Consumer)}, implementing this
	 * method does not replace other customization of the request config builder.
	...
	/**
	 * Customize the {@link ConnectionConfig.Builder}. Unlike
	 * {@link Rest5ClientBuilder#setConnectionConfigCallback(Consumer)}, implementing this
	 * method does not replace other customization of the connection config builder.
