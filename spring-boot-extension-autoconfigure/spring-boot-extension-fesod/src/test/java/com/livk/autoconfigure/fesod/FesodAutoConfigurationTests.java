...
import com.livk.context.fesod.resolver.ReactiveExcelMethodReturnValueHandler;
 ...
 * @author livk
 */
class FesodAutoConfigurationTests {

	@Test
	void testServlet() {
		WebApplicationContextRunner contextRunner = new WebApplicationContextRunner()
			.withConfiguration(AutoConfigurations.of(WebMvcAutoConfiguration.class, FesodAutoConfiguration.class));
	...
	void testReactive() {
		ReactiveWebApplicationContextRunner contextRunner = new ReactiveWebApplicationContextRunner()
			.withConfiguration(AutoConfigurations.of(WebFluxAutoConfiguration.class, FesodAutoConfiguration.class));
