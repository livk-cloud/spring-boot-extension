...
class StorageControllerTests {
	...
	static void properties(DynamicPropertyRegistry registry) {
		registry.add("spring.storage.access-key", minio::getUserName);
		registry.add("spring.storage.secret-key", minio::getPassword);
		registry.add("spring.storage.endpoint", minio::getS3URL);
		registry.add("spring.storage.type", () -> "minio");
	}
	...
	void test() throws Exception {
		String url = mockMvc.perform(get("/storage/test"))
