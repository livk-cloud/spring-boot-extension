...
public class ExcelHttpMessageConverter implements HttpMessageConverter<Object> {
	...
	public Object read(@NonNull Class<?> parameterType, HttpInputMessage inputMessage)
		...
		EasyExcelSupport.read(inputMessage.getBody(), excelModelClass, listener, requestExcel.ignoreEmptyRow());
	...
	public void write(@NonNull Object returnValue, MediaType contentType, @NonNull HttpOutputMessage outputMessage)
		...
		if (returnValue instanceof Collection) {
			...
			EasyExcelSupport.write(outputMessage.getBody(), excelModelClass, responseExcel.template(),
			...
			EasyExcelSupport.write(outputMessage.getBody(), excelModelClass, responseExcel.template(), result);
		}
	}
