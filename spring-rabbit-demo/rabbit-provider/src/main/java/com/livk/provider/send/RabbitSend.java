...
public class RabbitSend {
    ...
    public <T> void sendMsgDirect(Message<T> message) {
        ...
        rabbitTemplate.convertAndSend(DirectConfig.RABBIT_DIRECT_EXCHANGE,
                DirectConfig.RABBIT_DIRECT_BINDING, message);
    }
    ...
    public <T> void sendMsgHeaders(Message<T> message, Map<String, Object> map) {
        ...
        org.springframework.amqp.core.Message msg = new org.springframework.amqp.core.Message(message.toString().getBytes(), messageProperties);
