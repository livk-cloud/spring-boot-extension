...
image:https://codecov.io/gh/livk-cloud/spring-boot-extension/branch/main/graph/badge.svg?token=OA6j1PHzsI["codecov",link="https://codecov.io/gh/livk-cloud/spring-boot-extension"]
...
|--spring-boot-example
    ...
    |--spring-testcontainers-support(testcontainers测试工具包)
----
